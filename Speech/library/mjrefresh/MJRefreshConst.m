...
const CGFloat MJRefreshFastAnimationDuration = 0.2; // default 0.25 -> change by phunv14
const CGFloat MJRefreshSlowAnimationDuration = 0.2; // default 0.4 -> change by phunv14
