...
- (void)sd_setImageWithPreviousCachedImageWithURL:(nullable NSURL *)url
    ...
    [self sd_setImageWithURL:url placeholderImage:lastPreviousCachedImage ?: placeholder options:SDWebImageRetryFailed progress:progressBlock completed:completedBlock];
}
