...
+ (void)drawRect:(CGRect)bounds withParameters:(id<NSObject>)parameters_ isCancelled:(asdisplaynode_iscancelled_block_t)isCancelledBlock isRasterizing:(BOOL)isRasterizing
{
    NSDictionary *parameters = parameters_;
